...
Tarefa ler_tarefa(){
    ...
    printf("\nInforme o status da tarefa (0 - A fazer, 1 - Em andamento, 2 - Concluida):\n");
...
int main(){
    ...
    do{
        ...
        printf("6 - Exibir tarefas concluidas\n7 - Sair\n");
        printf("----------------------------------------------------------------------\n");
        scanf("%d", &opcao);
        getchar();
